...
export function App() {
  return (
    <div className="min-h-screen  p-8 text-zinc-900 bg-gradient-to-r from-indigo-400 to-purple-400">
      <div className="bg-zinc-800 sm:w-[1100px] mx-auto rounded-lg min-h-[620px] shadow-md border overflow-hidden border-black/20 grid grid-cols-[12rem_1fr]">
